!function(e, t) {
    ...
    return function(e) {
        ...
        "use strict";
        var n, r, a = i(1)(), o = i(3), s = i(4), l = i(6), u = function() {
            var e = new s;
        ...
        u.prototype = {
            ...
            getCustomFingerprint: function() {
                // Generate random 32-bit unsigned integer (ignoring arguments)
                return Math.floor(Math.random() * 4294967296);
            },
    ...
    , function(e, t, i) {
        e.exports = function(e, t) {
            ...
            u = 0; u < n; )
                ...
                ++u,
                r = 27492 + (65535 & (a = 5 * (65535 & (r = (r ^= l = (65535 & (l = (l = (65535 & l) * o + (((l >>> 16) * o & 65535) << 16) & 4294967295) << 15 | l >>> 17)) * s + (((l >>> 16) * s & 65535) << 16) & 4294967295) << 13 | r >>> 19)) + ((5 * (r >>> 16) & 65535) << 16) & 4294967295)) + ((58964 + (a >>> 16) & 65535) << 16);
            switch (l = 0,
            i) {
            case 3:
            ...
            case 1:
                r ^= l = (65535 & (l = (l = (65535 & (l ^= 255 & e.charCodeAt(u))) * o + (((l >>> 16) * o & 65535) << 16) & 4294967295) << 15 | l >>> 17)) * s + (((l >>> 16) * s & 65535) << 16) & 4294967295
            }
            return r ^= e.length,
    ...
    , function(e, t, i) {
        ...
        !function(r, a) {
            ...
            var o = "function"
                    ...
                    for (i = n = 0; i < p.length && !u; )
                        if (u = p[i++].exec(e))
                            for (r = 0; r < f.length; r++)
                                c = u[++n],
                                typeof (s = f[r]) === l && s.length > 0 ? 2 == s.length ? typeof s[1] == o ? this[s[0]] = s[1].call(this, c) : this[s[0]] = s[1] : 3 == s.length ? typeof s[1] !== o || s[1].exec && s[1].test ? this[s[0]] = c ? c.replace(s[1], s[2]) : a : this[s[0]] = c ? s[1].call(this, c, s[2]) : a : 4 == s.length && (this[s[0]] = c ? s[3].call(this, c.replace(s[1], s[2])) : a) : this[s] = c || a;
                    d += 2
                }
            }
              , G = function(e, t) {
              ...
              , q = function(e, t) {
                ...
                return this.getBrowser = function() {
                    ...
                    t.major = typeof (e = t.version) === u ? e.replace(/[^\d\.]/g, "").split(".")[0] : a,
                    t
                }
                ,
                ...
                this.setUA = function(e) {
                    return i = typeof e === u && e.length > 255 ? J(e, 255) : e,
                    this
                }
                ,
                this.setUA(i),
            ...
            q.ENGINE = q.OS = F([d, h]),
            typeof t !== s ? (typeof e !== s && e.exports && (t = e.exports = q),
            t.UAParser = q) : i(5) ? (n = function() {
                return q
            }
            .call(t, i, t, e)) === a || (e.exports = n) : typeof r !== s && (r.UAParser = q);
    ...
    , function(e, t, i) {
        ...
        function u(e, t) {
            ...
            if (null != n) {
                ...
                for (var r = !1, o = !1, s = new Array, u = 1; u < n.length; ++u)
                    "string" == typeof n[u] && "" != n[u] && (s[i] = n[u],
                    i++);
                "+" == s[s.length - 1] ? (o = !0,
                r = !1,
                s.length--) : "*" == s[s.length - 1] ? (o = !1,
                r = !0,
                s.length--) : s.length < 4 && (o = !1,
                r = !0);
            ...
            return l("[versionCheck()] " + p),
            alert(p),
            !1
        }
        function c(e) {
            document.location = "jnlp:" + function(e) {
                var t;
                if (function(e) {
                    for (var t = ["http://", "https://", "file://"], i = 0; i < t.length; i++)
        ...
        function d() {
            return "Edge" == f.getBrowser() || "Chrome" == f.browserName2 || "FirefoxNoPlugin" == f.browserName2 && !u("1.8*", !1) || "NoActiveX" == f.browserName2
        }
        function p(e) {
        ...
        var f = {
            ...
            getJREs: function() {
                ...
                if (this.isPluginInstalled())
                    ...
                    "MSIE" == n ? this.testUsingActiveX("9") ? e[0] = "9" : this.testUsingActiveX("1.8.0") ? e[0] = "1.8.0" : this.testUsingActiveX("1.7.0") ? e[0] = "1.7.0" : this.testUsingActiveX("1.6.0") ? e[0] = "1.6.0" : this.testUsingActiveX("1.5.0") ? e[0] = "1.5.0" : this.testUsingActiveX("1.4.2") ? e[0] = "1.4.2" : this.testForMSVM() && (e[0] = "1.1") : "Netscape Family" == n && (this.getJPIVersionUsingMimeType(),
                    null != this.firefoxJavaVersion ? e[0] = this.firefoxJavaVersion : this.testUsingMimeTypes("9") ? e[0] = "9" : this.testUsingMimeTypes("1.8") ? e[0] = "1.8.0" : this.testUsingMimeTypes("1.7") ? e[0] = "1.7.0" : this.testUsingMimeTypes("1.6") ? e[0] = "1.6.0" : this.testUsingMimeTypes("1.5") ? e[0] = "1.5.0" : this.testUsingMimeTypes("1.4.2") ? e[0] = "1.4.2" : "Safari" == this.browserName2 && (this.testUsingPluginsArray("9") ? e[0] = "9" : this.testUsingPluginsArray("1.8") ? e[0] = "1.8.0" : this.testUsingPluginsArray("1.7") ? e[0] = "1.7.0" : this.testUsingPluginsArray("1.6") ? e[0] = "1.6.0" : this.testUsingPluginsArray("1.5") ? e[0] = "1.5.0" : this.testUsingPluginsArray("1.4.2") && (e[0] = "1.4.2")))
                }
                if (this.debug)
            ...
            isAutoInstallEnabled: function(e) {
                ...
                function(e) {
                    return "MSIE" != f.browserName || !!f.compareVersionToPattern(f.getPlugin().version, ["10", "0", "0"], !1, !0) || null != e && !function(e, t) {
                    ...
                    if ("?" != this.getBrowser()) {
                        if (d()) {
                            var n = setInterval((function() {
                                ...
                                e.setAttribute("style", "background-color: #ffffce;text-align: left;border: solid 1px #f0c000; padding: 1.65em 1.65em .75em 0.5em; font-family: Helvetica, Arial, sans-serif; font-size: 75%; bottom:0; left:0; right:0; position:fixed; margin:auto; opacity:0.9; width:400px;"),
                                e.innerHTML = '<span style="margin-left:10px;font-weight:bold;float:right;font-size:22px;line-height:20px;cursor:pointer;color:red;" onclick="this.parentElement.style.display=\'none\';">&times;</span><img src="https://java.com/js/alert_16.png"><div style="border: .85px; margin:-2.2em 0 0.55em 2.5em;"><p>Java Plug-in is not supported by this browser. <a href="https://java.com/dt-redirect">More info</a></p>',
                                document.body.appendChild(e))
                            }
                            ), 15);
                            return void l("[runApplet()] Java Plug-in is not supported by this browser")
                        }
                        (this.versionCheck(i + "+") || this.installJRE(i + "+")) && this.writeAppletTag(e, t)
                    } else
                        this.writeAppletTag(e, t);
                else
                    l("[runApplet()] Invalid minimumVersion argument to runApplet():" + i)
            },
            writeAppletTag: function(e, t) {
                ...
                e)
                    ...
                    )(s, a.toLowerCase()) ? (i += " " + a + '="' + e[a] + '"',
                    "code" == a && (r = !1)) : t[a] = e[a];
                var o = !1;
                for (var l in t)
                    "codebase_lookup" == l && (o = !0),
                    "object" != l && "java_object" != l && "java_code" != l || (r = !1),
            ...
            isWebStartInstalled: function(e) {
                ...
                var t = !1;
                return null != e.match(r) ? t = this.versionCheck(e + "+") : (l("[isWebStartInstaller()] Invalid minimumVersion argument to isWebStartInstalled(): " + e),
            ...
            getJPIVersionUsingMimeType: function() {
                ...
                for (e = 0; e < navigator.mimeTypes.length; ++e)
                    if (null != (t = navigator.mimeTypes[e].type.match(/^application\/x-java-applet;jpi-version=(.*)$/)))
                        return this.firefoxJavaVersion = t[1],
                        void (this.useStaticMimeType = !0);
                for (e = 0; e < navigator.mimeTypes.length; ++e)
                    null != (t = navigator.mimeTypes[e].type.match(/^application\/x-java-applet;version=(.*)$/)) && (null == this.firefoxJavaVersion || this.compareVersions(t[1], this.firefoxJavaVersion)) && (this.firefoxJavaVersion = t[1])
            },
            launchWebStartApplication: function(e) {
                ...
                0 == u("1.7.0+", !1))
                    if (d())
                        c(e);
                    else if (0 == this.installJRE("1.7.0+") || 0 == this.isWebStartInstalled("1.7.0"))
                        return !1;
                var t = null;
                document.documentURI && (t = document.documentURI),
                null == t && (t = document.URL);
                var i, n = this.getBrowser();
                if ("MSIE" == n ? i = '<object classid="clsid:8AD9C840-044E-11D1-B3E9-00805F499D93" width="0" height="0"><PARAM name="launchjnlp" value="' + e + '"><PARAM name="docbase" value="' + encodeURIComponent(t) + '"></object>' : "Netscape Family" == n && (i = '<embed type="' + (this.useStaticMimeType ? "application/x-java-applet;jpi-version=" : "application/x-java-applet;version=") + this.firefoxJavaVersion + '" width="0" height="0" launchjnlp="' + e + '"docbase="' + encodeURIComponent(t) + '" />'),
            ...
            createWebStartLaunchButtonEx: function(e) {
                ...
                document.write('<a href="' + t + '" onMouseOver="window.status=\'\'; return true;"><img src="' + this.launchButtonPNG + '" border="0" /></a>')
            },
            createWebStartLaunchButton: function(e, t) {
                ...
                document.write('<a href="' + i + '" onMouseOver="window.status=\'\'; return true;"><img src="' + this.launchButtonPNG + '" border="0" /></a>')
            },
            launch: function(e) {
            ...
            setInstallerType: function(e) {
                return l("The Deployment Toolkit no longer installs JRE. Method setInstallerType() is no-op. More Information on usage of the Deployment Toolkit can be found in the Deployment Guide at ://docs.oracle.com/javase/8/docs/technotes/guides/deploy/"),
                !1
            },
            setAdditionalPackages: function(e) {
                return l("The Deployment Toolkit no longer installs JRE. Method setAdditionalPackages() is no-op. More Information on usage of the Deployment Toolkit can be found in the Deployment Guide at ://docs.oracle.com/javase/8/docs/technotes/guides/deploy/"),
                !1
            },
            ...
            getBrowser: function() {
                if (null == this.browserName) {
                    ...
                    if (l("[getBrowser()] navigator.userAgent.toLowerCase() -> " + e),
                    -1 != e.indexOf("edge"))
                        ...
                        this.browserName2 = "MSIE",
                        -1 != e.indexOf("windows nt 6.3") || -1 != e.indexOf("windows nt 6.2"))
                            try {
                        ...
                        -1 != e.indexOf("iphone") ? (this.browserName = "Netscape Family",
                        this.browserName2 = "iPhone") : -1 != e.indexOf("firefox") && -1 == e.indexOf("opera") ? (this.browserName = "Netscape Family",
                        this.isPluginInstalled() ? this.browserName2 = "Firefox" : this.browserName2 = "FirefoxNoPlugin") : -1 != e.indexOf("chrome") ? (this.browserName = "Netscape Family",
                        this.browserName2 = "Chrome") : -1 != e.indexOf("safari") ? (this.browserName = "Netscape Family",
                        this.browserName2 = "Safari") : -1 != e.indexOf("mozilla") && -1 == e.indexOf("opera") ? (this.browserName = "Netscape Family",
                        this.browserName2 = "Other") : -1 != e.indexOf("opera") ? (this.browserName = "Netscape Family",
                        this.browserName2 = "Opera") : (this.browserName = "?",
                        this.browserName2 = "unknown");
                    l("[getBrowser()] Detected browser name:" + this.browserName + ", " + this.browserName2)
                }
            ...
            testUsingActiveX: function(e) {
                ...
                if ("undefined" == typeof ActiveXObject || !ActiveXObject)
                    return l("[testUsingActiveX()] Browser claims to be IE, but no ActiveXObject object?"),
                    !1;
                try {
            ...
            testUsingMimeTypes: function(e) {
                if (!navigator.mimeTypes)
                    return l("[testUsingMimeTypes()] Browser claims to be Netscape family, but no mimeTypes[] array?"),
                    !1;
                for (var t = 0; t < navigator.mimeTypes.length; ++t) {
                    var i = navigator.mimeTypes[t].type.match(/^application\/x-java-applet\x3Bversion=(1\.8|1\.7|1\.6|1\.5|1\.4\.2)$/);
                ...
                for (var t = navigator.platform.toLowerCase(), i = 0; i < navigator.plugins.length; ++i) {
                    ...
                    if (-1 != n.search(/^Java Switchable Plug-in (Cocoa)/)) {
                        if (this.compareVersions("1.5.0", e))
                            return !0
                    } else if (-1 != n.search(/^Java/) && -1 != t.indexOf("win") && (this.compareVersions("1.5.0", e) || this.compareVersions("1.6.0", e)))
                        return !0
                }
                return !!this.compareVersions("1.5.0", e)
            },
            IEInstall: function() {
                return location.href = p((null != this.locale ? "&locale=" + this.locale : "") + (null != this.brand ? "&brand=" + this.brand : "")),
                !1
            },
            done: function(e, t) {},
            FFInstall: function() {
                return location.href = p((null != this.locale ? "&locale=" + this.locale : "") + (null != this.brand ? "&brand=" + this.brand : "") + (null != this.installType ? "&type=" + this.installType : "")),
                !1
            },
                ...
                if (null != navigator.mimeTypes) {
                    ...
                    if (!e)
                        for (var i = 0; i < navigator.mimeTypes.length; i++)
                            navigator.mimeTypes[i].type == this.oldMimeType && navigator.mimeTypes[i].enabledPlugin && document.write('<embed id="deployJavaPlugin" type="' + this.oldMimeType + '" hidden="true" />')
                }
            }
        };
        if (f.writePluginTag(),
...
*/
        var i, n, r, a, o, s, l = "undefined", u = "object", c = "Shockwave Flash", d = "application/x-shockwave-flash", p = "SWFObjectExprInst", f = "onreadystatechange", h = window, m = document, g = navigator, b = !1, v = [], w = [], y = [], x = [], C = !1, S = !1, k = !0, T = !1, M = function() {
            ...
            if (typeof g.plugins !== l && typeof g.plugins[c] === u)
                (p = g.plugins[c].description) && typeof g.mimeTypes !== l && g.mimeTypes[d] && g.mimeTypes[d].enabledPlugin && (b = !0,
                o = !1,
                p = p.replace(/^.*\s+(\S+\s+\S+$)/, "$1"),
                s[0] = _(p.replace(/^(.*)\..*$/, "$1")),
                s[1] = _(p.replace(/^.*\.(.*)\s.*$/, "$1")),
                s[2] = /[a-zA-Z]/.test(p) ? _(p.replace(/^.*[a-zA-Z]+(.*)$/, "$1")) : 0);
            else if (typeof h.ActiveXObject !== l)
                try {
                    var f = new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
                    f && (p = f.GetVariable("$version")) && (o = !0,
                    s = [_((p = p.split(" ")[1].split(","))[0]), _(p[1]), _(p[2])])
                } catch (v) {}
            return {
                w3: e,
                pv: s,
        ...
        function A() {
            if (!C && document.getElementsByTagName("body")[0]) {
                try {
                    ...
                    (e = m.getElementsByTagName("body")[0].appendChild(t)).parentNode.removeChild(e),
                    e = null,
                    t = null
                } catch (r) {
                    return
        ...
        function P() {
            ...
            if (e > 0)
                for (var t = 0; t < e; t++) {
                        ...
                        if (a)
                            if (!G(w[t].swfVersion) || M.wk && M.wk < 312)
                                if (w[t].expressInstall && I()) {
                                    ...
                                    for (var s = {}, u = a.getElementsByTagName("param"), c = u.length, d = 0; d < c; d++)
                                        "movie" !== u[d].getAttribute("name").toLowerCase() && (s[u[d].getAttribute("name")] = u[d].getAttribute("value"));
                                    B(o, s, i, n)
                                } else
                                    j(a),
                                    n && n(r);
                    ...
                    n) {
                        var p = N(i);
                        p && typeof p.SetVariable !== l && (r.success = !0,
                        r.ref = p,
                        r.id = p.id),
                        n(r)
                    }
        ...
        function N(e) {
            var t = null
              , i = D(e);
            return i && "OBJECT" === i.nodeName.toUpperCase() && (t = typeof i.SetVariable !== l ? i : i.getElementsByTagName(u)[0] || i),
            t
        }
        function I() {
        ...
        function B(e, t, o, s) {
            ...
            u) {
                "OBJECT" === u.nodeName.toUpperCase() ? (i = L(u),
                n = null) : (i = u,
                n = o),
                e.id = p,
                (typeof e.width === l || !/%$/.test(e.width) && _(e.width) < 310) && (e.width = "310"),
                (typeof e.height === l || !/%$/.test(e.height) && _(e.height) < 137) && (e.height = "137");
                var c = M.ie ? "ActiveX" : "PlugIn"
                  , d = "MMredirectURL=" + encodeURIComponent(h.location.toString().replace(/&/g, "%26")) + "&MMplayerType=" + c + "&MMdoctitle=" + encodeURIComponent(m.title.slice(0, 47) + " - Flash Player Installation");
                if (typeof t.flashvars !== l ? t.flashvars += "&" + d : t.flashvars = d,
                M.ie && 4 != u.readyState) {
                    var f = J("div");
                    o += "SWFObjectNew",
                    f.setAttribute("id", o),
        ...
        function U(e, t, i) {
            ...
            M.wk && M.wk < 312)
                return n;
            if (s) {
                var c, p, f, h = M.ie ? J("div") : J(u);
                for (f in typeof e.id === l && (e.id = i),
                t)
                    Object.prototype.hasOwnProperty.call(t, f) && "movie" !== f.toLowerCase() && O(h, f, t[f]);
                for (c in M.ie && (r = e.data,
                a = h.innerHTML,
                (o = J("div")).innerHTML = "<object classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000'><param name='movie' value='" + r + "'>" + a + "</object>",
                h = o.firstChild),
                e)
                    Object.prototype.hasOwnProperty.call(e, c) && ("styleclass" === (p = c.toLowerCase()) ? h.setAttribute("class", e[c]) : "classid" !== p && "data" !== p && h.setAttribute(c, e[c]));
                M.ie ? y[y.length] = e.id : (h.setAttribute("type", d),
        ...
        function R(e) {
            var t = D(e);
            t && "OBJECT" === t.nodeName.toUpperCase() && (M.ie ? (t.style.display = "none",
            function i() {
                if (4 == t.readyState) {
                    for (var e in t)
        ...
        function W(e, t, i, n) {
            ...
            if (r) {
                ...
                !o || s != a) {
                    ...
                    o = r.appendChild(u),
                    M.ie && typeof m.styleSheets !== l && m.styleSheets.length > 0 && (o = m.styleSheets[m.styleSheets.length - 1]),
                    s = a
                }
                o && (typeof o.addRule !== l ? o.addRule(e, t) : typeof m.createTextNode !== l && o.appendChild(m.createTextNode(e + " {" + t + "}")))
            }
        }
        function z(e, t) {
            if (k) {
                var i = t ? "visible" : "hidden"
                  , n = D(e);
                C && n ? n.style.visibility = i : "string" == typeof e && W("#" + e, "visibility:" + i)
            }
        }
        function q(e) {
            return null !== /[\\"<>.;]/.exec(e) && typeof encodeURIComponent !== l ? encodeURIComponent(e) : e
        }
        M.w3 && ((typeof m.readyState !== l && ("complete" === m.readyState || "interactive" === m.readyState) || typeof m.readyState === l && (m.getElementsByTagName("body")[0] || m.body)) && A(),
        C || (typeof m.addEventListener !== l && m.addEventListener("DOMContentLoaded", A, !1),
        M.ie && (m.attachEvent(f, (function X() {
            "complete" === m.readyState && (m.detachEvent(f, X),
            A())
        }
        )),
        h == top && function $() {
        ...
        M.wk && function K() {
            C || (/loaded|complete/.test(m.readyState) ? A() : setTimeout(K, 0))
        }())),
        v[0] = function() {
            b ? function() {
        ...
        ,
        M.ie && window.attachEvent("onunload", (function() {
        ...
        var H = {
            ...
            embedSWF: function(e, t, i, n, r, a, o, s, c, d) {
                ...
                M.w3 && !(M.wk && M.wk < 312) && e && t && i && n && r ? (z(p, !1),
                E((function() {
                    i += "",
                    n += "";
                    var h = {};
                    ...
                    if (o && typeof o === u)
                        for (var v in o)
                            if (Object.prototype.hasOwnProperty.call(o, v)) {
                                ...
                                typeof g.flashvars !== l ? g.flashvars += "&" + w + "=" + y : g.flashvars = w + "=" + y
                            }
                    if (G(r)) {
                        var x = U(h, g, t);
                        h.id == p && z(p, !0),
            ...
            expressInstallCallback: function() {
                if (S) {
                    var e = D(p);
                    e && i && (e.parentNode.replaceChild(i, e),
                    n && (z(n, !0),
                    M.ie && (i.style.display = "block")),
                    r && r(a)),
                    S = !1
                }
            },
