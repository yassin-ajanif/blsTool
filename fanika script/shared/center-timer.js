/**
 * Center-top live clock — HH:MM:SS:mmm (Morocco local time).
 */
(function () {
  if (window.__fanikaCenterTimerInstalled) return;
  window.__fanikaCenterTimerInstalled = true;

  const TIMER_ID = 'fanika-center-timer';
  ...
  function ensureTimer() {
    ...
    el.id = TIMER_ID;
    el.setAttribute('data-fanika', 'center-timer');
    el.style.cssText = [
      'position:fixed',
      'top:8px',
      'left:50%',
